            ...
            <header className="App-header">
                <form onSubmit={onSubmitHandler}> 
                    <div>
                        ...
                        <input type="text" name="username" id="username" value={values.username} onChange={onChangeHandler} />
                    </div>

                    <div>
                        <label htmlFor="age">Age</label>
                        <input type="number" name="age" id="age" value={values.age ?? ""} onChange={onChangeHandler} />
                    </div>

                    {
                        Number(values.age) >= 18 && (
                            ...
                            <div>
                                ...
                                <input type="text" name="creditCard" id="credit-card" value={values.creditCard} onChange={onChangeHandler} />
                            </div>
                        )}
                    ...
                    <div>
                        ...
                        <textarea name="bio" id="bio" cols="15" rows="5" value={values.bio} onChange={onChangeHandler}></textarea>
                    </div>
